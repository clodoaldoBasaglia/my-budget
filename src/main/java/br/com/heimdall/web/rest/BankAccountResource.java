...
/**
 * REST controller for managing {@link br.com.heimdall.domain.BankAccount}.
 */
@RestController
    ...
    public ResponseEntity<BankAccount> partialUpdateBankAccount(
        ...
        Optional<BankAccount> result = bankAccountRepository
            ...
            .map(existingBankAccount -> {
                if (bankAccount.getDescriptionName() != null) {
                    existingBankAccount.setDescriptionName(bankAccount.getDescriptionName());
                }
                if (bankAccount.getAccountNumber() != null) {
                    existingBankAccount.setAccountNumber(bankAccount.getAccountNumber());
                }
                if (bankAccount.getAccountDigit() != null) {
                    existingBankAccount.setAccountDigit(bankAccount.getAccountDigit());
                }
                if (bankAccount.getAgencyNumber() != null) {
                    existingBankAccount.setAgencyNumber(bankAccount.getAgencyNumber());
                }
                if (bankAccount.getAgencyDigit() != null) {
                    existingBankAccount.setAgencyDigit(bankAccount.getAgencyDigit());
                }
